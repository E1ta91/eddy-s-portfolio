...
import modelUrl from '../../assets/3d/glbs/babytub.glb?url';

function CarrierModel({ mouse, isDragging }) {
    ...
    <div className="absolute inset-0 h-full w-full touch-none">
      ...
      >
        ...
        <Suspense fallback={null}>
          <CarrierModel mouse={mouse} isDragging={isDragging} />
...
export default InfantCarrierHeroCanvas;
