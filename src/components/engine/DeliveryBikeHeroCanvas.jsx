...
import modelUrl from '../../assets/3d/glbs/bike1.glb?url';

function DeliveryBikeModel({ mouse, isDragging }) {
    ...
    <div className="absolute inset-0 h-full w-full touch-none">
      ...
      >
        ...
        <Suspense fallback={null}>
          <DeliveryBikeModel mouse={mouse} isDragging={isDragging} />
...
export default DeliveryBikeHeroCanvas;
