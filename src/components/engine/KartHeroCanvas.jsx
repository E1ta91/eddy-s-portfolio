...
import modelUrl from '../../assets/3d/glbs/kart.glb?url';

function KartModel({ mouse, isDragging }) {
    ...
    <div className="absolute inset-0 h-full w-full touch-none">
      ...
      >
        ...
        <Suspense fallback={null}>
          <KartModel mouse={mouse} isDragging={isDragging} />
