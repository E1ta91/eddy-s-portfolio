...
import modelUrl from '../../assets/3d/glbs/bike2.glb?url';

function ScooterModel({ mouse, isDragging }) {
...
const ElectricScooterHeroCanvas = () => {
    ...
    <div className="absolute inset-0 h-full w-full touch-none">
      ...
      >
        ...
        <Suspense fallback={null}>
          <ScooterModel mouse={mouse} isDragging={isDragging} />
...
export default ElectricScooterHeroCanvas;
