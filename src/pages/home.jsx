...
const Home = () => {
  ...
  return (
    <div className="atelier-glow min-h-screen bg-canvas text-ink">
        ...
        <div className="section-shell relative z-10 w-full">
          <div className="animate-fade-up max-w-xl">
            ...
            <p className="mt-5 max-w-sm text-base leading-relaxed text-muted sm:text-lg">
              CAD, digital fabrication, and product development — from SolidWorks to the shop floor.
            </p>
      ...
      <main>
        <section id="about" className="scroll-mt-24 border-t border-line py-20 sm:py-24">
          <About />
        </section>
        <section id="experience" className="scroll-mt-24 border-t border-line py-20 sm:py-24">
          <Experience />
        </section>
        <section id="skills" className="scroll-mt-24 border-t border-line py-20 sm:py-24">
          <Skills />
        </section>
        <section id="projects" className="scroll-mt-24 border-t border-line py-20 sm:py-24">
          <Projects />
        </section>
        <section id="contact" className="scroll-mt-24 border-t border-line py-20 sm:py-24">
          <Contact />
        </section>
      </main>
