    ...
    <ProjectShell>
      <div className="mx-auto mb-10 max-w-3xl text-center">
        ...
        <p className="mt-5 text-base leading-relaxed text-muted sm:text-lg">
          A cargo-ready electric bike built for Ghana&apos;s last-mile economy — weaving through Accra
          and Kumasi traffic to move market goods, parcels, and food without the fuel cost or fumes
          of a motorcycle.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            ...
            <div className="md:col-span-3">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {[
                  ['Cargo', 'Rear rack and frame geometry sized for crates, parcels, and market loads'],
