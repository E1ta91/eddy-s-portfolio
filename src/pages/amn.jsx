    ...
    <ProjectShell>
        ...
        {[amn1, amn2].map((src, i) => (
          <div key={i} className="w-full overflow-hidden border border-line md:w-1/2 lg:w-2/5">
            <img
              ...
              src={src}
              alt={i === 0 ? 'AMN drone overview' : 'AMN drone close-up'}
            />
          </div>
        ))}
      </div>
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-6 border border-line bg-[var(--surface-elevated)] p-6 sm:p-8">
          ...
          <Detail label="Tools">
            Prototype components 3D printed in PLA on a Qidi X-Plus for flight testing.
          </Detail>
          <Detail label="Features">
            5&nbsp;km range with 1&nbsp;kg payload, advanced stabilization, and rugged construction for
